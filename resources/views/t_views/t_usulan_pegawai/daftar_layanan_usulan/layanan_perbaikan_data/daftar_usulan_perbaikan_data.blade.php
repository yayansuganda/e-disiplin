...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Daftar Usulan Perbaikan Data</h1>
    <!-- end page-header -->
...
<div class="panel panel-inverse">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Usulan Perbaikan Data</h4>
    </div>
...
$('#data-table-responsive').dataTable({
            ...
            serverSide: true,
            searching:false,
            ajax: "{{ url('/table/daftar_usulan_perbaikan_data')}}" + "/" + 0,
            columns: [
...
$('#id_m_skpd').on('change', function(e){
    ...
    $('#data-table-responsive').dataTable({
            ...
            serverSide: true,
            searching:false,
            ajax: "{{ url('/table/daftar_usulan_perbaikan_data')}}" + "/" + id,
            columns: [
            {data: 'DT_RowIndex', name: 'id_usulan_pegawai'},
            {
                data: 'nip',
