{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_perbaikan_data', $model->id_usulan_pegawai] : 'usulan_perbaikan_data.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Data Perbaikan</label>

                <div class="col-md-6">
                    {!! Form::textarea('lainnya',null,['class'=>'form-control', 'rows' => 2, 'id'=>'lainnya']) !!}
                </div>
            </div>
