...
<div class="panel panel-inverse">
    <ol class="pull-right">
    <a href="{{route('usulan_perbaikan_data.show', Request::segment(3))}}" class="btn btn-sm btn-success modal-show" title="Create Usulan Perbaikan Data" data-toggle="modal">Tambah Data Pegawai</a>
    </ol>
            ...
            <table id="data-table-fixed-header"  class="table table-striped table-bordered data" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap">Data Perbaikan</th>
...
var oTable = $('.data').DataTable({
    ...
    serverSide: true,
    Searchable: true,
    ajax: "{{ route('table.usulan_perbaikan_data', Request::segment(3))}}",
    columns: [
