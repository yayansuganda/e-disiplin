{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_ujian_dinas', $model->id_usulan_pegawai] : 'usulan_ujian_dinas.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Jenis Usulan Ujian Dinas</label>
                <div class="col-md-6">


                        <select id="lainnya" name="lainnya" class="default-select2 form-control">
                            <option label="---pilih---">
                            <option value="Ujian Dinas Tingkat I" {{$model->lainnya == 'Ujian Dinas Tingkat I'  ? 'selected' : ''}}>Ujian Dinas Tingkat I</option>
                            <option value="Ujian Dinas Tingkat II" {{$model->lainnya == 'Ujian Dinas Tingkat II'  ? 'selected' : ''}}>Ujian Dinas Tingkat II</option>
                    </select>
