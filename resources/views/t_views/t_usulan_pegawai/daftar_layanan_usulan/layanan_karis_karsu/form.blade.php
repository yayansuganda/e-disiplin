{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_karis_karsu', $model->id_usulan_pegawai] : 'usulan_karis_karsu.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Usulan Karsu/Karis</label>
                <div class="col-md-6">


                        <select id="lainnya" name="lainnya" class="default-select2 form-control">
                            <option label="---pilih---">
                            <option value="Kartu Suami" {{$model->lainnya == 'Kartu Suami'  ? 'selected' : ''}}>Kartu Suami</option>
                            <option value="Kartu Istri" {{$model->lainnya == 'Kartu Istri'  ? 'selected' : ''}}>Kartu Istri</option>
                    </select>
