{!! Form::model($model,  [
    'route'=>['update_create.data_verifikasi_usulan_diklat', $model->id_usulan_pegawai],
        ...
        <div class="col-lg-8 col-md-6">
                        <div class="form-group row m-b-10">
                            ...
                            <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('jenis_diklat',$model->lainnya, ['class' => 'form-control', 'id'=>'jenis_diklat', 'readonly'=>true]) !!}
                                    </div>
                                </div>
