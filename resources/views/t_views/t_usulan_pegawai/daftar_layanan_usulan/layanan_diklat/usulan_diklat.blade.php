...
<div class="panel panel-inverse">
    <ol class="pull-right">
    <a href="{{route('usulan_diklat.show', Request::segment(3))}}" class="btn btn-sm btn-success modal-show" title="Create Usulan Diklat" data-toggle="modal">Tambah Data Pegawai</a>
    </ol>
            ...
            <table id="data-table-fixed-header"  class="table table-striped table-bordered data" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap">Jenis Usulan Diklat</th>
...
var oTable = $('.data').DataTable({
    ...
    serverSide: true,
    Searchable: true,
    ajax: "{{ route('table.usulan_diklat', Request::segment(3))}}",
    columns: [
