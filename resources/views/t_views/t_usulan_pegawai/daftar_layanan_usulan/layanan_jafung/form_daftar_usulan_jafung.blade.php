{!! Form::model($model,  [
    'route'=>['update_create.data_verifikasi', $model->id_usulan_pegawai],
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div id="tampil">
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-8">
                                        {!!  Form::select('id_m_jabatan',$model->id_m_jabatan == '' ? [] : $nama_jabatan,null,['placeholder'=>'Pilih','class' => 'form-control default-select2','id'=>'id_m_jabatan']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-8">
                                        {!!  Form::select('id_m_skpd_subbidang',$nama_subbidang,null,['placeholder'=>'Pilih','class' => 'form-control default-select2','id'=>'id_m_skpd_subbidang']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-8">
                                        {!!  Form::select('id_m_skpd_bidang',[],null,['placeholder'=>'Pilih','class' => 'form-control default-select2','id'=>'id_m_skpd_bidang']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-8">
                                        {!!  Form::select('id_m_skpd',[],null,['placeholder'=>'Pilih','class' => 'form-control default-select2','id'=>'id_m_skpd_bidang']) !!}
