...
<div class="panel panel-inverse">
    <ol class="pull-right">
    <a href="{{route('usulan_peningkatan_pendidikan.show', Request::segment(3))}}" class="btn btn-sm btn-success modal-show" title="Create Usulan Peningkatan Pendidikan" data-toggle="modal">Tambah Data Pegawai</a>
    </ol>
            ...
            <table id="data-table-fixed-header"  class="table table-striped table-bordered data" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap">Usulan Pendidikan Ke</th>
...
var oTable = $('.data').DataTable({
    ...
    serverSide: true,
    Searchable: true,
    ajax: "{{ route('table.usulan_peningkatan_pendidikan', Request::segment(3))}}",
    columns: [
