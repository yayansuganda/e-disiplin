{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_peningkatan_pendidikan', $model->id_usulan_pegawai] : 'usulan_peningkatan_pendidikan.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Peningkatan Pendidikan ke</label>
                <div class="col-md-6">

                    <select id="lainnya" name="lainnya" class="default-select2 form-control">
                        <option label="---pilih---">
                        @foreach($tingkat_pendidikan as $data)
                            <option value="{{$data->nama_m_tingkat_pendidikan}}" {{$model->lainnya == $data->nama_m_tingkat_pendidikan  ? 'selected' : ''}}>{{$data->nama_m_tingkat_pendidikan}} </option>
                        @endforeach
