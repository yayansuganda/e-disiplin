{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_mutasi', $model->id_usulan_pegawai] : 'usulan_mutasi.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Jenis Usulan Mutasi</label>
                <div class="col-md-6">


                        <select id="lainnya" name="lainnya" class="default-select2 form-control">
                            <option label="---pilih---">
                            <option value="Mutasi antar Instansi dari dan ke Pemerintah KSB" {{$model->lainnya == 'Mutasi antar Instansi dari dan ke Pemerintah KSB'  ? 'selected' : ''}}>Mutasi antar Instansi dari dan ke Pemerintah KSB</option>
                            <option value="Mutasi antar SKPD KSB" {{$model->lainnya == 'Mutasi antar SKPD KSB'  ? 'selected' : ''}}>Mutasi antar SKPD KSB</option>
                    </select>
