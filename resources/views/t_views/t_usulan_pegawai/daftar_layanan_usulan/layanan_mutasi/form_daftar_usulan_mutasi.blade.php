{!! Form::model($model,  [
    'route'=>['update_create.data_verifikasi_usulan_mutasi', $model->id_usulan_pegawai],
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div id="tampil">
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('jenis_mutasi',$model->exists == '' ? null : $model->lainnya, ['class' => 'form-control', 'id'=>'jenis_mutasi', 'readonly' => true]) !!}
                                    </div>
                                </div>

                                <div class="form-group row m-b-10">
                                        <label class="col-md-3 text-md-right col-form-label">Nomor SK Mutasi</label>
                                        <div class="col-md-8">
                                            {!! Form::text('nomor_sk_mutasi',null, ['class' => 'form-control', 'id'=>'nomor_sk_mutasi']) !!}
                                        </div>
                                    </div>

                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Tanggal SK Mutasi</label>
                                    <div class="col-md-8">
                                        <div class="input-group date datepicker-default"   data-date-format="dd-mm-yyyy" >
                                            {!! Form::text('tanggal_sk_mutasi',null, ['class' => 'form-control', 'placeholder'=>'Tanggal SK Mutasi', 'id'=>'tanggal_sk_mutasi']) !!}
                                ...
                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Upload SK Mutasi</label>
                                    <div class="col-md-8">
