...
<div class="panel panel-inverse">
    <ol class="pull-right">
    <a href="{{route('usulan_mutasi.show', Request::segment(3))}}" class="btn btn-sm btn-success modal-show" title="Create Usulan KGB" data-toggle="modal">Tambah Data Pegawai</a>
    </ol>
            ...
            <table id="data-table-fixed-header"  class="table table-striped table-bordered data" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap">Jenis Usulan Mutasi</th>
...
var oTable = $('.data').DataTable({
    ...
    serverSide: true,
    Searchable: true,
    ajax: "{{ route('table.usulan_mutasi', Request::segment(3))}}",
    columns: [
