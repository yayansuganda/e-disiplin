...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Daftar Usulan Karpeg</h1>
    <!-- end page-header -->
...
<div class="panel panel-inverse">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Usulan Karpeg</h4>
    </div>
...
$('#data-table-responsive').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('/table/daftar_usulan_karpeg')}}" + "/" + 0,
            columns: [
...
$('#id_m_skpd').on('change', function(e){
    ...
    $('#data-table-responsive').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('/table/daftar_usulan_karpeg')}}" + "/" + id,
            columns: [
            {data: 'DT_RowIndex', name: 'id_usulan_pegawai'},
            {
                data: 'nip',
