...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Daftar Usulan Taspen</h1>
    <!-- end page-header -->
...
<div class="panel panel-inverse">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Usulan Taspen</h4>
    </div>
...
$('#data-table-responsive').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('/table/daftar_usulan_taspen')}}" + "/" + 0,
            columns: [
...
$('#id_m_skpd').on('change', function(e){
    ...
    $('#data-table-responsive').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('/table/daftar_usulan_taspen')}}" + "/" + id,
            columns: [
            {data: 'DT_RowIndex', name: 'id_usulan_pegawai'},
            {
                data: 'nip',
