{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_pensiun', $model->id_usulan_pegawai] : 'usulan_pensiun.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Jenis Usulan Pensiun</label>
                <div class="col-md-6">


                        <select id="lainnya" name="lainnya" class="default-select2 form-control">
                            <option label="---pilih---">
                            <option value="Usulan Pensiun PNS yang mencapai BUP dan atau APS" {{$model->lainnya == 'Usulan Pensiun PNS yang mencapai BUP dan atau APS'  ? 'selected' : ''}}>Usulan Pensiun PNS yang mencapai BUP dan atau APS</option>
                            <option value="Usulan Pensiun PNS JANDA atau DUDA" {{$model->lainnya == 'Usulan Pensiun PNS JANDA atau DUDA'  ? 'selected' : ''}}>Usulan Pensiun PNS JANDA atau DUDA</option>
                    </select>
