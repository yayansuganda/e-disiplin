{!! Form::model($model,  [
    'route'=>['update_create.data_verifikasi_usulan_pensiun', $model->id_usulan_pegawai],
...
<div class="row">
        ...
        <div class="col-lg-8 col-md-6">
                        <div class="form-group row m-b-10">
                            ...
                            <div class="form-group row m-b-10">
                                <label class="col-md-3 text-md-right col-form-label">Jabatan Terakhir</label>
                                <div class="col-md-8">
                                    {!! Form::text('nama_jabatan',$sk_jabatan_terakhir->nama_m_jabatan, ['class' => 'form-control', 'id'=>'nama_jabatan', 'readonly' => true]) !!}
                                </div>
                            </div>
                            ...
                            <div id="tampil">
                                ...
                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Jenis Pensiun</label>
                                    <div class="col-md-8">
                                        {!! Form::text('jenis_pensiun',$model->exists == '' ? null : $model->lainnya, ['class' => 'form-control', 'id'=>'nip', 'readonly' => true]) !!}
                                    </div>
                                </div>

                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Tanggal Pensiun</label>
                                    <div class="col-md-8">
                                        <div class="input-group date datepicker-default"   data-date-format="dd-mm-yyyy" >
                                            {!! Form::text('tanggal_pensiun',null, ['class' => 'form-control', 'placeholder'=>'Tanggal Pensiun', 'id'=>'tanggal_pensiun']) !!}
                                ...
                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Upload SK Pensiun</label>
                                    <div class="col-md-8">
                                        {!!  Form::file('path_sk_pensiun',['placeholder'=>'Pilih','class' => 'form-control','id'=>'path_sk_pensiun','hidden'=>true]) !!}
                                        <label for="path_sk_pensiun" class="btn-block">{{$model->exists == '' || $model->nama_file_sk_pensiun == '' ? 'Pilih File' : $model->nama_file_sk_pensiun}}</label>
                                    </div>
                                </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                @if ($model->lainnya == 'Usulan Pensiun PNS yang mencapai BUP dan atau APS')
                        ...
                        @if ($data_prajabatan->nama_file_karsu_karis != null)
                            <a href="{{url('preview_file_pegawai/'.$model->nip.'/'.$data_prajabatan->nama_file_karsu_karis)}}"  title="Preview File {{$data_prajabatan->nama_file_karsu_karis}}" class="btn-show-preview btn btn-inverse btn-sm btn-block"><i class="fas fa-lg fa-fw m-r-10 fa-file-pdf"></i><strong>KARSU/KARIS</strong></a>
                        @else
                            <a class="btn btn-default disabled btn-sm btn-block"><i class="fas fa-lg fa-fw m-r-10 fa-file-pdf"></i><strong>FILE KARSU BELUM DI UPLOAD</strong></a>
                        @endif

                        @if ($data_pegawai->nama_file_surat_nikah != null)
                            <a href="{{url('preview_file_pegawai/'.$model->nip.'/'.$data_pegawai->nama_file_surat_nikah)}}"  title="Preview File {{$data_pegawai->nama_file_surat_nikah}}" class="btn-show-preview btn btn-inverse btn-sm btn-block"><i class="fas fa-lg fa-fw m-r-10 fa-file-pdf"></i><strong>KARSU/KARIS</strong></a>
                        @else
                            <a class="btn btn-default disabled btn-sm btn-block"><i class="fas fa-lg fa-fw m-r-10 fa-file-pdf"></i><strong>SURAT NIKAH BELUM DI UPLOAD</strong></a>
                        @endif

                        @if ($data_pegawai->nama_file_ktp != null)
                            <a href="{{url('preview_file_pegawai/'.$model->nip.'/'.$data_pegawai->nama_file_ktp)}}"  title="Preview File {{$data_pegawai->nama_file_ktp}}" class="btn-show-preview btn btn-inverse btn-sm btn-block"><i class="fas fa-lg fa-fw m-r-10 fa-file-pdf"></i><strong>KARSU/KARIS</strong></a>
                        @else
                            <a class="btn btn-default disabled btn-sm btn-block"><i class="fas fa-lg fa-fw m-r-10 fa-file-pdf"></i><strong>FILE KTP BELUM DI UPLOAD</strong></a>
                        @endif
