...
<div class="panel panel-inverse">
    <ol class="pull-right">
    <a href="{{route('usulan_ujian_pi.show', Request::segment(3))}}" class="btn btn-sm btn-success modal-show" title="Create Usulan KGB" data-toggle="modal">Tambah Data Pegawai</a>
    </ol>
...
var oTable = $('.data').DataTable({
    ...
    serverSide: true,
    Searchable: true,
    ajax: "{{ route('table.usulan_ujian_pi', Request::segment(3))}}",
    columns: [
