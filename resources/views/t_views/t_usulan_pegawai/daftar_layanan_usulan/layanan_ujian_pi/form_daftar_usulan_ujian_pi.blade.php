{!! Form::model($model,  [
    'route'=>['update_create.data_verifikasi_usulan_ujian_pi', $model->id_usulan_pegawai],
        ...
        <div class="col-lg-8 col-md-6">
                        <div class="form-group row m-b-10">
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('jenis_ujian_pi',$model->exists == '' ? null : $model->lainnya, ['class' => 'form-control', 'id'=>'jenis_ujian_pi', 'readonly' => true]) !!}
                                </div>
                            </div>
                            ...
                            <div id="tampil">
                                ...
                                <div class="form-group row m-b-10">
                                        <label class="col-md-3 text-md-right col-form-label">Nomor Sertifikat Ujian PI</label>
                                        <div class="col-md-8">
                                            {!! Form::text('nomor_sertifikat_ujian_pi',null, ['class' => 'form-control', 'id'=>'nomor_sertifikat_ujian_pi']) !!}
                                        </div>
                                    </div>

                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Tanggal Sertifikat Ujian PI</label>
                                    <div class="col-md-8">
                                        <div class="input-group date datepicker-default"   data-date-format="dd-mm-yyyy" >
                                            {!! Form::text('tanggal_sertifikat_ujian_pi',null, ['class' => 'form-control', 'placeholder'=>'Tanggal Sertifikat Ujian PI', 'id'=>'tanggal_sertifikat_ujian_pi']) !!}
                                ...
                                <div class="form-group row m-b-10">
                                    <label class="col-md-3 text-md-right col-form-label">Upload Sertifikat Ujian PI</label>
                                    <div class="col-md-8">
                                        {!!  Form::file('path_ujian_pi',['placeholder'=>'Pilih','class' => 'form-control','id'=>'path_ujian_pi','hidden'=>true]) !!}
                                        <label for="path_ujian_pi" class="btn-block">{{$model->exists == '' || $model->nama_file_ujian_pi == '' ? 'Pilih File' : $model->nama_file_ujian_pi}}</label>
                                    </div>
                                </div>
