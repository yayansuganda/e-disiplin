{!! Form::model($model,  [
    'route'=>$model->exists ? ['update_data.usulan_ujian_pi', $model->id_usulan_pegawai] : 'usulan_ujian_pi.store',
...
<div class="row">
    <div class="col-md-10 offset-md-2">
            ...
            <div class="form-group row m-b-10">
                <label class="col-md-3 text-md-right col-form-label">Jenis Usulan Ujian PI</label>
                <div class="col-md-6">


                        <select id="lainnya" name="lainnya" class="default-select2 form-control">
                            <option label="---pilih---">
                            <option value="Ujian PI I" {{$model->lainnya == 'Ujian PI I'  ? 'selected' : ''}}>Ujian PI I</option>
                            <option value="Ujian PI II" {{$model->lainnya == 'Ujian PI II'  ? 'selected' : ''}}>Ujian PI II</option>
                    </select>
