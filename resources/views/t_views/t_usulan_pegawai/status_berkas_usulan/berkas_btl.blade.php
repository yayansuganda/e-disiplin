...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Usulan Berkas Tidak Lengkap</h1>
    <!-- end page-header -->
...
<div class="panel panel-inverse">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Berkas Tidak Lengkap (BTL)</h4>
    </div>

    <div class="panel-body">

        <table id="data-table-responsive"  class="table table-striped table-bordered data3 " style="width:100%">
            <thead>
                <tr>
...
var oTable3 = $('.data3').DataTable({
    ...
    processing: true,
    serverSide: true,
    ajax: "{{ route('table.daftar_pegawai_btl')}}",
    columns: [
