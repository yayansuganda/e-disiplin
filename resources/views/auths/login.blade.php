        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                ...
                <div class="news-caption">
                    <h4 class="caption-title"><b>Selamat Datang</b></h4>
                    <p>
                        <b> SISTEM INFORMASI DISIPLIN PNS KABUPATEN SUMBAWA BARAT </b>
                    </p>
                </div>
            </div>
            <!-- end news-feed -->
                ...
                <div class="login-content">
                    <form action="/postlogin" method="POST" class="margin-bottom-0">
                        ...
                        <div class="form-group m-b-15">
                            <input type="text" name="nip" id="nip" class="form-control form-control-lg" placeholder="Nip" required />
                        </div>
                        <div class="form-group m-b-15">
                        ...
                        <p class="text-center text-grey-darker">
                            &copy; SUBBID PDA, BKPSDM KSB 2019
                        </p>
                    </form>
                </div>
                <!-- end login-content -->
