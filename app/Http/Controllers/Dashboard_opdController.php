...
class Dashboard_opdController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.dashboard_opd',compact('skpd','chart_skpd','chart_pangkat_golongan_terakhir','chart_pendidikan','chart_eselon','chart_jenis_jabatan'));
    }
